      ...
      448: (e, t, n) => {
        ...
        function xa(e) {
          ...
          function s(e, t, n, r) {
            return null !== t && t.elementType === n.type
              ...
              : (((r = $i(n.type, n.key, n.props, null, e.mode, r)).ref = Sa(e, t, n)),
                (r.return = e),
                r);
          }
          function c(e, t, n, r) {
          ...
          function d(e, t, n) {
            ...
            if ('object' == typeof t && null !== t) {
              switch (t.$$typeof) {
                case S:
                  return (
                    ((n = $i(t.type, t.key, t.props, null, e.mode, n)).ref = Sa(e, null, t)),
                    (n.return = e),
                    n
                  );
                case E:
                ...
                case S:
                  e: {
                    ...
                    a.type === x
                      ...
                      : (((i = $i(a.type, a.key, a.props, null, e.mode, i)).ref = Sa(e, r, a)),
                        (i.return = e),
                        (e = i));
                  }
                  return u(e);
            ...
            if (t) {
              ...
              if (!Ba(e, t)) {
                if (!(t = qr(n.nextSibling)) || !Ba(e, t))
                  return (e.flags = (-1025 & e.flags) | 2), (ja = !1), void (Ua = e);
                Va(Ua, n);
              }
          ...
          return (
            ...
            i.useEffect(
              function () {
                ...
                if (!sr(u, e)) {
                  (e = n(t._source)),
                    sr(f, e) || (c(e), (e = ci(v)), (l.mutableReadLanes |= e & l.pendingLanes)),
        ...
        function au(e) {
          switch (e.tag) {
            ...
            case 3:
              if ((Ma(), sl(pl), sl(dl), Ka(), 0 != (64 & (t = e.flags)))) throw Error(o(285));
            ...
            case 22:
              ...
              if (null !== (t = null !== (t = n.updateQueue) ? t.lastEffect : null)) {
                ...
                do {
                  var l = e;
                  (r = l.next),
                    0 != (4 & (l = l.tag)) && 0 != (1 & l) && (Ri(n, e), Mi(n, e)),
                    (e = r);
                } while (e !== t);
              }
              return;
              ...
              return (
                ...
                4 & n.flags &&
                  (null === t
                    ? e.componentDidMount()
                    : ((r =
                        n.elementType === n.type ? t.memoizedProps : Xl(n.type, t.memoizedProps)),
        ...
        function mi(e, t) {
          for (
            t &= ~ju, t &= ~Au, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes;
            0 < t;
        ...
        function vi(e) {
          ...
          return (
            (e.finishedWork = e.current.alternate), (e.finishedLanes = t), Ti(e), pi(e, Bl()), null
          );
        }
        function gi(e, t) {
          var n = Tu;
        ...
        function Ui(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            zu === e &&
              (Ou & n) === n &&
              (4 === Iu || (3 === Iu && (62914560 & Ou) === Ou && 500 > Bl() - Bu)
                ? ki(e, 0)
                : (ju |= n)),
            pi(e, t);
        }
                  ...
                  case 13:
                    if (null !== t.memoizedState)
                      return 0 != (n & t.child.childLanes)
                        ? Go(e, t, n)
                        : (cl(Da, 1 & Da.current), null !== (t = nu(e, t, n)) ? t.sibling : null);
                    cl(Da, 1 & Da.current);
                    break;
                  case 19:
              ...
              if (
                ...
                if (
                  ((a = (l = t.stateNode).hydrate) &&
                    ((Aa = qr(t.stateNode.containerInfo.firstChild)), (Ua = t), (a = ja = !0)),
                  a)
                ) {
  ...
  (() => {
    ...
    const t = function () {
      return (
        ...
        e.createElement('h1', { className: 'helloWorld' }, 'Hello World!')
      );
    };
    n(935).render(e.createElement(t, null), document.querySelector('#root'));
  })();
})();
